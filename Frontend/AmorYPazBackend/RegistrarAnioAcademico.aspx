            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ControlToValidate="txtAnio"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="rfvFechaInicio" runat="server" ControlToValidate="dtpFechaInicio"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="rfvFechaFin" runat="server" ControlToValidate="dtpFechaFin"
