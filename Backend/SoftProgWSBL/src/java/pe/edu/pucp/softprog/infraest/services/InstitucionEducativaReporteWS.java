...
public class InstitucionEducativaReporteWS {
    public InstitucionEducativaReporteWS(){
        System.setProperty("user.language", "es");
        System.setProperty("user.country", "PE");
        System.setProperty("user.timezone", "GMT-5");
    }
    
    @WebMethod(operationName = "devolverReporteInstitucion")
    public byte[] devolverReporte(@WebParam(name = "idInstitucion") int idInstitucion, 
